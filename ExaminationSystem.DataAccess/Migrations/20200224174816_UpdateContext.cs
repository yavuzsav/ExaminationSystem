    ...
    public partial class UpdateContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    ClassLevelName = table.Column<string>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    NumberOfQuestions = table.Column<int>(nullable: false, defaultValue: 20),
                    LengthOfExam = table.Column<int>(nullable: false, defaultValue: 30)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 2, 24, 20, 48, 15, 524, DateTimeKind.Local).AddTicks(3216))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    OnCreated = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 2, 24, 20, 48, 15, 503, DateTimeKind.Local).AddTicks(577)),
                    OnModified = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_ClassLevels_ClassLevelId",
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_AspNetUsers_ModifiedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 2, 24, 20, 48, 15, 520, DateTimeKind.Local).AddTicks(8326))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    OnCreated = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 2, 24, 20, 48, 15, 514, DateTimeKind.Local).AddTicks(4117)),
                    OnModified = table.Column<DateTime>(nullable: true),
                    CreatedUserId = table.Column<string>(nullable: true),
                    ModifiedUserId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Questions_AspNetUsers_ModifiedUserId",
                        column: x => x.ModifiedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ClassLevelId",
                table: "Categories",
                column: "ClassLevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_ModifiedUserId",
                table: "Questions",
                column: "ModifiedUserId");
        }
